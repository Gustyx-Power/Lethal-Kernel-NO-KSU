...
static const struct freq_tbl  ftbl_gpu_cc_gx_gfx3d_clk_src_sdm845_v2[] = {
	...
	F(260000000, P_CRC_DIV,  1, 0, 0),
	F(335000000, P_CRC_DIV,  1, 0, 0),
	F(410000000, P_CRC_DIV,  1, 0, 0),
	F(530000000, P_CRC_DIV,  1, 0, 0),
	F(610000000, P_CRC_DIV,  1, 0, 0),
	F(730000000, P_CRC_DIV,  1, 0, 0),
...
static void gpu_cc_gfx_sdm845_fixup_sdm845v2(void)
{
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_LOWER] =
		260000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_LOW] = 335000000;
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_NOMINAL_L1] =
		610000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_HIGH] = 730000000;
